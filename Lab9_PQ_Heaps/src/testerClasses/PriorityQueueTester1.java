...
public class PriorityQueueTester1 {
	...
	public static void main(String[] args) {
		...
		//DisplayablePriorityQueue<Integer, String> pq = new UnsortedListPriorityQueue<>(new IntegerComparator2());
		//Removes the biggest elements first ^^^^^
		...
		//DisplayablePriorityQueue<Integer, String> pq = new SortedListPriorityQueue<>(new IntegerComparator2());
		//DisplayablePriorityQueue<Integer, String> pq = new HeapListPriorityQueue<>(new IntegerComparator2());
		DisplayablePriorityQueue<Integer, String> pq = new HeapPriorityQueue<>(new IntegerComparator2());
		add(pq, 20, "twenty");
		removeMin(pq); 
		removeMin(pq); 
		add(pq, 10, "ten");
